...
namespace realvirtual
{
    ...
    public class Drive_Cylinder : BehaviorInterface
    {
        ...
        [Header("Settings")] public bool OneBitCylinder = false; //!< if set to true only one bit is needed to controll the cylinder. If Out=false the cylinder moves in
        ...
        [HideIf("OneBitCylinder")] public bool _in = false; //!< true for moving the cylinder in.
        ...
        [HideIf("OneBitCylinder")]public PLCOutputBool In; //!< Signal for moving the cylinder in
