    ...
    class LibraryExtractor
    {
        ...
        static bool LibraryExists(string folder)
        {
           /* var library = GetAppropriateLibraryInfo();
            return File.Exists(Path.Combine("Assets/realvirtual/private/Interfaces/EthernetIP/libplctag.NativeImport/runtime/win_x64/", library.FileName));*/
        ...
        static void ExtractAppropriateLibraryToDirectory(string outputDirectory)
        {
          /*  var library = GetAppropriateLibraryInfo();
            ...
            var extractPath = Path.Combine("Assets/realvirtual/private/Interfaces/EthernetIP/libplctag.NativeImport/runtime/win_x64/plctag.dll", library.FileName);
