...
public class RoboDK
{
    ...
    /// <summary>
    /// Gets all the user  s from the open RoboDK station.
    ...
    public static string Color2Hex(UnityEngine.Color color)
    {
        byte[] bytes = new byte[4];
        bytes[0] = 0;  //g4a
        bytes[1] = 0;//g4a
    ...
    public void setColor(List<Item> item_list, List<UnityEngine.Color> color_list)
    {
