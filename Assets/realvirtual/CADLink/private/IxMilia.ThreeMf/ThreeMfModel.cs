...
namespace ThreeMf
{
    public class ThreeMfModel
    {
        ...
        internal static ThreeMfModel LoadXml(XElement root, string package, float scale)
        {
            ...
            var resourceMap = model.ParseResources(root.Element(ResourcesName), package, scale);
        ...
        private Dictionary<int, ThreeMfResource> ParseResources(XElement resources, string package, float scale)
        {
            ...
            {
                var resource = ThreeMfResource.ParseResource(element, resourceMap, package,scale);
                if (resource != null)
                {
